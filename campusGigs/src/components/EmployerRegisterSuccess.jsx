    ...
    <div className="flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="mt-3 flex justify-center items-center w-full px-4">
            <p>Your account is pending admin approval, <Link to="/sign-in" className="text-decoration: underline text-blue-500 font-semibold font-style: italic">Sign In.</Link></p>
        </div>
      </div>
