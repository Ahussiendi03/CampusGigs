    ...
    <div className="flex justify-center relative">
      ...
      <div className="flex-1 flex flex-col p-4">
        ...
        <div>
          ...
          <div className="flex items-center mb-6 ml-7">
            <p className="text-1xl font-bold">CERTIFICATE OF REGISTRATION:</p>
          </div>
          <img src={signUpImage2} className="mt-2 w-[370px] h-[230px] mb-2" />
          <p className="ml-24 block py-2 px-4 bg-maroon-700 text-yellow-300 font-bold text-base rounded-lg text-center w-[170px]">
            Update COR
          </p>
        </div>
...
export default ApplicantsMyAcc;