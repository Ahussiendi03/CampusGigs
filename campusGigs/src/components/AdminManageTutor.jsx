              ...
              <tbody>
                {pendingTutorPosts.map((tutor) => (
                  <tr key={tutor._id} className="bg-gray-100 hover:bg-gray-200">
                    ...
                    <td className="border border-gray-300 px-4 py-2">{tutor.address}</td>
                    <td className="border border-gray-300 px-4 py-2">{tutor.tutorType}</td>
                    <td className="border border-gray-300 px-4 py-2">{tutor.schedule}</td>
                    <td className="border border-gray-300 px-4 py-2">{tutor.salary}</td>
                    <td className="border border-gray-300 px-4 py-2 capitalize">{tutor.status}</td>
                    <td className="border border-gray-300 px-4 py-2">
                      <button
                        className="bg-green-500 text-white px-3 py-1 rounded mr-2"
                        onClick={() => handleAcceptTutor(tutor._id)}
                      >
                        Accept
                      </button>
                      <button
